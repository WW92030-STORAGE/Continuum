...
public class HousingItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        else if (level.getBlockState(hbp).isSolid()) player.sendSystemMessage(Component.literal("This is a solid block!"));
