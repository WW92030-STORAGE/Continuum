...
public class Main
{
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        MinecraftForge.EVENT_BUS.register(DataAttacher.class);
    }
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.DARKNESS.get(), NPCRenderer::new);
    }
